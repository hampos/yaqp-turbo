 ...
 * @author chung
 */
public interface JPipelineStatus {
    ...
    /**
     * Clears the JPipelineStatus object.
     */
    void clear();
    ...
    /**
     * Returns a characteristic message from the JPipelineStatus
     * objects.
     * @return message.
     */
    String getMessage();
    ...
    /**
     * Updates the message holded by JPipelineStatus.
     * @param message
     */
