...
public interface JBatchStatus {
    ...
    /**
     * Clears the JBatchStatus object.
     */
    void clear();
    ...
    /**
     * Returns a characteristic message from the JBatchStatus
     * objects.
     * @return message.
     */
    String getMessage();
    ...
    /**
     * Updates the message holded by JBatchStatus.
     * @param message
     */
